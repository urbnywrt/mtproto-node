...
- **Пересборка образа telemt** под текущую версию (3.5.7). Работающие контейнеры
  остаются на старом образе и переедут на неё только при пересоздании — обновление
  само их не трогает. Какой контейнер на какой версии, видно в панели.
...
- Образ telemt останется собранным под версию из форка; чтобы вернуть прежнюю,
